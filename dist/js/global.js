        ...
        if ($(window).innerWidth() >= 1200) {
            ...
            if (sidebar.offset().top <= scrollTop) {
                ...
                if (scrollTop + sidebar.find('.sidebar-box').innerHeight() < footer.offset().top) {
                    ...
                    var bot = -(footer.offset().top - scrollTop - winHeight);
